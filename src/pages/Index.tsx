...
const Index = () => {
  ...
  const [trafficMode, setTrafficMode] = useState('conventional'); // conventional, load-aware
  const [mapView, setMapView] = useState('congestion'); // congestion, density, traffic-lights

  return (
    <div className="min-h-screen bg-slate-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-4 shadow-lg">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm">Load-Aware Traffic Light Management Dashboard</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <div className="text-right">
              <p className="text-sm text-slate-300">System Status</p>
              <p className="font-semibold capitalize text-green-400">{simulationState}</p>
            </div>
            <div className="text-right">
